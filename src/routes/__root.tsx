...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VozAtiva" },
      { name: "description", content: "Dispositivo Arduino para comunicação assistiva de crianças autistas não-verbais." },
      { name: "author", content: "VozAtiva" },
      { property: "og:title", content: "VozAtiva" },
      { property: "og:description", content: "Dispositivo Arduino para comunicação assistiva de crianças autistas não-verbais." },
